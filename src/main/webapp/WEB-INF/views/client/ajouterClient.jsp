				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-primary">
							...
							<c:url value="/client/enregistrer" var="urlEnregistrer"></c:url>
								<f:form modelAttribute="client" action="${ urlEnregistrer}"
									method="post" enctype="multipart/form-data">
									<f:hidden path="idClient"/>
									<div class="form-group">
										<label><fmt:message key="common.nom"></fmt:message></label> <f:input
											path ="nom" class="form-control" placeholder="Nom"/>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label><fmt:message key="common.mail"></fmt:message></label> <f:input
											path="mail" class="form-control" placeholder="Mail" />
									</div>
					...
					<i class="fa fa-save"> &nbsp;<fmt:message key="common.enregistrer"> </fmt:message></i>
									</button>
					<a href='<c:url value="/client/"></c:url>' class="btn btn-danger">
					<i class="fa fa-arrow-left">&nbsp;
					<fmt:message key="common.annuler"></fmt:message></i></a>
								</div>
