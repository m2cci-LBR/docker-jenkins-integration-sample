...
public class GenericDaoImpl<E> implements IGenericDao<E> {
	...
	// Tout d'abord il faut definir l Entity Manager
	...
	public void remove(Long id) {
		E tab = em.getReference(type, id);// recuperer la reference de la table
		em.remove(tab);
	...
	public E findOne(String paramName, Object paramValue) {
		Query query = em.createQuery("select t from" + type.getSimpleName() + "t where " + paramName + " = :x"); //pour passer des param = :x
